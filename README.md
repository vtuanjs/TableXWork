...
| METHOD | API                               | PARAMS                                                                       | RETURN   |
|--------|-----------------------------------|------------------------------------------------------------------------------|----------|
| POST   | /                                 | body: { title, description, isAllowMemberAddMember }                         | table  |
|        | /:tableId/delete                | params: { tableId }                                                        | table  |
|        | /:tableId/restore               | params: { tableId }                                                        | table  |
|        | /:tableId/stored                | params: { tableId }                                                        | table  |
|        | /:tableId/undoStored            | params: { tableId }                                                        | table  |
|        | /:tableId/add-members           | params: { tableId }, body: { userIds }                                     |          |
|        | /:tableId/remove-members        | params: { tableId }, body: { userIds }                                     |          |
|        | /:tableId/agree-join-table    | params: { tableId }                                                        |          |
|        | /:tableId/disagree-join-table | params: { tableId }                                                        |          |
|        | /:tableId/leave-table         | params: { tableId }                                                        |          |
|        | /:tableId/change-user-role      | params: { tableId }, body: { userId, role }                                | user     |
| GET    | /                                 |                                                                              | tables |
|        | /:tableId                       | params: { tableId }                                                        | table  |
|        | /:tableId/show-members          | params: { tableId }                                                        | members  |
| PUT    | /:tableId                       | params: { tableId },  body: { title, description, isAllowMemberAddMember } | table  |
| DELETE | /:tableId                       | params: { tableId }                                                        | raw      |

#### JOB

| METHOD | API                       | PARAMS                                                                      | RETURN  |
|--------|---------------------------|-----------------------------------------------------------------------------|---------|
| POST   | /                         | body: { title, description, isAllowMemberAddMember },  query: { tableId } | job     |

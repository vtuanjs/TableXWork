...
router.get('/:teamId', checkPermit({
    model: 'team',
    roles: 'admin'
}), team.getDetail)

router.put('/:teamId', checkPermit({
    model: 'team',
    roles: 'admin'
}), team.updateTeam)

router.post("/:teamId/add-members", checkPermit({
    model: 'team',
    roles: 'user'
}), team.addMembers)

router.post("/:teamId/remove-members", checkPermit({
    model: 'team',
    roles: 'admin'
}), team.removeMembers)
...
router.delete("/:teamId/", checkPermit({
    model: 'team',
    roles: 'admin'
}), team.deleteTeam)

router.post("/:teamId/change-user-role", checkPermit({
    model: 'team',
    roles: 'admin'
}), team.changeUserRole)
